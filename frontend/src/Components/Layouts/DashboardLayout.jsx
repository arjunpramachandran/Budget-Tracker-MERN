            ...
            <div className="flex-1 p-6">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Summary of your spending — {month}</p>
                    </div>

                    <div className="flex items-center gap-4">
                        <select value={month} onChange={(e) => setMonth(e.target.value)} className="bg-white p-2 rounded-lg border">
                            {months.map((m) => (
